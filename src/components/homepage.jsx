    ...
    <div>
      ...
      <div className="">
        <div className="text-center mb-10">
            <SubHeading
                subHeading="Meet the heroes behind the magic"
            />
        </div>
        ...
        <div className="bg-white shadow-inner w-full sm:w-full md:w-6/12 lg:w-4/12 p-5 mb-4 text-center">
            <Avatars avatarImage={Avatar1} name="Esther Howard" role="Founder"/>
        </div>
        <div className="bg-white shadow-inner w-full sm:w-full md:w-6/12 lg:w-4/12 p-5 mb-4">
            <Avatars avatarImage={Avatar2} name="Cody Fisher" role="Developer"/>
        </div>
        <div className="bg-white shadow-inner w-full sm:w-full md:w-6/12 lg:w-4/12 p-5 mb-4">
            <Avatars avatarImage={Avatar3} name="Brooklyn Simmons" role="Designer"/>
        </div>
        </div>
